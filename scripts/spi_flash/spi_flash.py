...
SDIO_READ_DATA_BUFFER_RESPONSE = (
...
class SDIODirect:
    def __init__(self, ser):
        ...
        self._sdio_write_data_buffer = mcu.CommandWrapper(
            ser, SDIO_WRITE_DATA_BUFFER
        )
...
class SDCardSDIO:
    ...
    def _send_app_cmd_with_response(
        self, cmd, args, ignoreCRC=False, get_rt=False
    ):
        # CMD55 tells the SD Card that the next command is an
        # Application Specific Command.
